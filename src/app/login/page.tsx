  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-4xl flex-col items-center justify-center px-6 py-16">
      ...
      <p className="mt-4 text-center text-base text-gray-600">
        Todo Coach를 사용하려면 로그인해 주세요
      </p>
      <button
        type="button"
        onClick={() => signIn("google", { callbackUrl: "/todo" })}
        className="mt-8 flex items-center gap-3 rounded-xl border border-gray-300 bg-white px-6 py-3 text-sm font-semibold shadow-sm transition hover:-translate-y-0.5 hover:shadow"
      >
